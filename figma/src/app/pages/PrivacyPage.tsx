...
export function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F3]">
      <SEO title="Privacy Policy" description="Travel Capsule AI privacy policy. Learn how we collect, use, and protect your personal data including photos and travel preferences." />
      {/* Header */}
