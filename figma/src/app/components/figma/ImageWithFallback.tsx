...
export function ImageWithFallback(props: React.ImgHTMLAttributes<HTMLImageElement> & { showSpinner?: boolean }) {
  ...
  const { src, alt, style, className, showSpinner, ...rest } = props
