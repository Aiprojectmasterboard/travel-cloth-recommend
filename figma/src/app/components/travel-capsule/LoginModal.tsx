  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative w-[420px] max-w-[90vw] bg-white rounded-2xl p-8" style={{ boxShadow: "0 24px 48px rgba(0,0,0,.15)" }}>
        ...
        <p className="text-[15px] text-[#57534e] mb-8" style={{ fontFamily: bodyFont }}>
        ...
        <button
          ...
          className="w-full h-[52px] flex items-center justify-center gap-3 bg-white border border-[#E8DDD4] rounded-xl hover:bg-[#FDF8F3] hover:border-[#C4613A]/30 transition-all cursor-pointer"
