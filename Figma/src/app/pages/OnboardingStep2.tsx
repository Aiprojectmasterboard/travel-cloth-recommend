...
import wardrobeImg from "figma:asset/94873ae744f2a797c5c10269a41b6763829932a2.png";
...
export function OnboardingStep2() {
  ...
  return (
    ...
    >
      ...
      {/* Gender Selection */}
      <div className="mt-10">
        <label className="text-[#57534e] block mb-4">Gender Selection</label>
      ...
      {/* Body Info */}
      <div className="mt-10">
        <label className="text-[#57534e] block mb-1">Body Info</label>
