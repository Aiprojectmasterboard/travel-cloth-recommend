  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        />
        <div style={{ width: 80, height: 2, backgroundColor: '#D4AF37', marginBottom: 24 }} />
        <div
          style={{
            fontSize: 64,
            fontWeight: 700,
        ...
        >
          ...
          <span style={{ fontSize: 52, fontStyle: 'italic', color: '#D4AF37', fontWeight: 400, marginTop: 4 }}>
            AI
          </span>
        </div>
        <div style={{ fontSize: 24, color: '#c4a882', marginTop: 28, textAlign: 'center', maxWidth: 700, lineHeight: 1.5 }}>
