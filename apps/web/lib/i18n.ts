...
const ja: Translations = {
  ...
  hero: {
    ...
    heading1: '天気の心配、',
    heading2: 'もう終わり。',
    sub: '天気を推測する時代は終わりました。AIが東京、パリ、そしてその先のためのパーフェクトなパッキングリストを作ります。',
    cta: 'カプセルを作る',
    estLabel: '設立 2025',
...
const fr: Translations = {
  ...
  hero: {
    badge: "L'avenir de la garde-robe de voyage",
    heading1: 'La fin des',
  ...
  weather: {
    sectionLabel: 'Stylisme données live',
...
const es: Translations = {
  ...
  hero: {
    badge: 'El futuro del guardarropa de viaje',
    heading1: 'El fin de',
    heading2: 'las suposiciones del tiempo.',
    ...
    headline1: 'El fin de',
    headline2: 'las suposiciones del tiempo.',
    headline3: '',
  ...
  weather: {
    sectionLabel: 'Estilismo con datos en vivo',
  ...
  blueprint: {
    ...
    heading: 'El plano de 10 prendas',
